                                            ...
                                            <div class="col-8">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <img class="img-fluid" style="height: 50px!important;" src="https://ps.w.org/user-avatar-reloaded/assets/icon-256x256.png?rev=2540745" alt="user img">
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                        <h3>{{$user->name}}</h3>
                                                    </div>
                                                ...
                                                <ul class="moreoption">
                                                    <li class="navbar nav-item dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" href="{{route('dashboard')}}">Voltar</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
